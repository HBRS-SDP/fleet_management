...
if __name__ == '__main__':
    planner = FMSPathPlanner(server_ip='172.16.1.100', server_port=8000, building='AMK')

    print("Planning path from basement pickup area {AMK_D_L-1_C41_LA1} to ward {AMK_B_L4_C1_LA2}")
    ...
    plan = planner.get_path_plan(start_floor=-1, destination_floor=-1, start_area='AMK_B_L-1_C4',
                                 destination_area='AMK_A_L-1_C42', start_local_area='AMK_B_L-1_C4_LA1',
    ...
    plan = planner.get_path_plan(start_floor=-1, destination_floor=-1, start_area='AMK_A_L-1_C42',
                                 destination_area='AMK_B_L-1_C2', start_local_area='AMK_A_L-1_C42_LA2',
    ...
    plan = planner.get_path_plan(start_floor=-1, destination_floor=-1, start_area='AMK_B_L-1_C4',
                                 destination_area='AMK_A_L-1_C11', start_local_area='AMK_B_L-1_C4_LA1',
    ...
    plan = planner.get_path_plan(start_floor=-1, destination_floor=-1, start_area='AMK_A_L-1_C11',
                                 destination_area='AMK_B_L-1_C2', start_local_area='AMK_A_L-1_C11_LA1',
                                 destination_local_area='AMK_B_L-1_C2_LA1')
