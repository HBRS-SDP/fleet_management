...
class TestPathPlanner(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.docking_local_areas = cls.path_planner.osm_bridge.get_all_local_area_of_behaviour_type(
            cls.building, "docking"
        )
        cls.undocking_local_areas = cls.path_planner.osm_bridge.get_all_local_area_of_behaviour_type(
            cls.building, "undocking"
        )
